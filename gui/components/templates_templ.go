...
func Preferences(prefs *models.Preferences) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" class=\"range range-info range-xs\" hx-post=\"/hops/savejitter\" hx-trigger=\"change\"></label></form></li><li><form><label class=\"flex cursor-pointer\"><span class=\"label-text w-full\">Display Logs</span> <input type=\"checkbox\" id=\"displaylogs\" class=\"toggle\" value=\"synthwave\" onclick=\"displayLogs()\"></label></form></li></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
